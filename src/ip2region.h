...
IP2R_API uint_t ip2region_memory_search_string(ip2region_t, char *,
                                               datablock_t);

/**
 * get the region associated with the specified ip address with binary search
 * algorithm
 *
 * @param	ip2rObj
 * @param	ip
...
IP2R_API uint_t ip2region_binary_search_string(ip2region_t, char *,
                                               datablock_t);
...
/**
 * get a unsinged long(4bytes) from a specified buffer start from the specified
 * offset
 *
 * @param	buffer
 * @param	offset
